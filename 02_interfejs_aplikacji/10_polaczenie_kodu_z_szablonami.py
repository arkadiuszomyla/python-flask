...
@app.route('/')
def index():
    return render_template("index_bootstrap_cantor.html")
...
def exchange():
    ...
    if request.method == 'GET':
        return render_template('exchange_cantor.html', offer=offer) #przekazujemy oferty jako parametr do wykorzystania
    else:
        currency = 'EUR'
        ...
        return render_template('exchange_result_cantor.html', currency=currency, amount=amount,
