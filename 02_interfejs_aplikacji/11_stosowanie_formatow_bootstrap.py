...
@app.route('/')
def index():
    return render_template("index_bootstrap_cantor_reformat.html")
...
def exchange():
    ...
    if request.method == 'GET':
        return render_template('exchange_cantor_reformat.html', offer=offer) #przekazujemy oferty jako parametr do wykorzystania
    else:
        currency = 'EUR'
        ...
        return render_template('exchange_result_cantor_reformat.html', currency=currency, amount=amount,
