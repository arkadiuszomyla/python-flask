...
def history():
    ...
    return render_template('history_with_delete.html', acive_menu='history', transactions=transactions) #dodajemy też parametr acive_menu, w menu.html pogrubioną czcionke mają strony, które są aktualnie aktywne
